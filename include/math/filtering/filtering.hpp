...
namespace CRAP {
    namespace filtering {
        ...
        template<int number_of_observations>
        struct observation {
            typedef Matrix<double, number_of_observations, 1> measurement_t;
            typedef Matrix<double, number_of_observations, number_of_observations> covariance_t;
            measurement_t z;
            covariance_t R;
        };
    ...
    template<int number_of_states, int number_of_controls>
    std::ostream& operator<<(std::ostream& o, filtering::KalmanFilter<number_of_states, number_of_controls> kf) {
